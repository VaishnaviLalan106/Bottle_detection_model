...
Its a very small model and works only with bottle detection. It has few errors maybe like it wont detect high quality bottle images, only recognices camera clicked blurred effect of bottle images clicked from my phone.
